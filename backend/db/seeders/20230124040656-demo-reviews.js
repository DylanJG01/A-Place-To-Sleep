  ...
  async up (queryInterface, Sequelize) {
    ...
    return queryInterface.bulkInsert(options, [
      ...
      },
      {
        spotId: 2,
        userId: 2,
        review: 'The Second best place on this side of the street, unfortunately I am dead and therefore have quite a hard time reaching that side of the street without help',
        stars: 3,
      },
      {
        spotId: 3,
